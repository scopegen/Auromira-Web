...
function Campaigns() {
    ...
    return (
        <>
            <IconBar />
            <section class="height-100 section campaign " data-stellar-background-ratio="0.5">
