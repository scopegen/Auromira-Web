...
function PrivacyPolicy() {
    ...
    return (
        <>
            <IconBar />
            <section className="page-header-box section privacy-policy-bg parallax" data-stellar-background-ratio="0.5">
                <div className="container">
                    <div className="row">
                        <div className="col-sm-12 text-center">
                            <div className="title-box">
                                <h3 className="text-white m-b-0">Privacy Policy</h3>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className="section martop50">
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <p>Welcome to Auromira Entertainment.

Auromira Entertainment (“us”, “we”, or “our”) operates <a href="http://www.auromirafilms.com/" style="color: #9422a3;">http://www.auromirafilms.com/</a> (hereinafter referred to as “Service”).

Our Privacy Policy governs your visit to <a href="http://www.auromirafilms.com/" style="color: #9422a3;">http://www.auromirafilms.com/</a>, and explains how we collect, safeguard and disclose information that results from your use of our Service.
...
Our Terms and Conditions (“Terms”) govern all use of our Service and together with the Privacy Policy constitutes your agreement with us (“agreement”).</p>
                        ...
                        <h2>2. Definitions</h2>
                        <p>
                            SERVICE means the <a href="http://www.auromirafilms.com/" style="color: #9422a3;">http://www.auromirafilms.com/</a> website operated by Auromira Entertainment.
...
THE USER is the individual using our Service. The User corresponds to the Data Subject, who is the subject of Personal Data.</p>
                        ...
                        <h4 className="data">Personal Data</h4>
...
<ul>
                        ...
                        <h4 className="data">Usage Data</h4>
...
<h4 className="data">Location Data</h4>

We may use and store information about your location if you give us permission to do so (“Location Data”). We use this data to provide features of our Service, to improve and customize our Service.

You can enable or disable location services when you use our Service at any time by way of your device settings.

<h4 className="data">Tracking Cookies Data</h4>
...
<ul>
                            ...
                            <li>0.2. Preference Cookies: We use Preference Cookies to remember your preferences and various settings.</li>
...
<h2>5. Use of Data</h2>
                        ...
                        <p>Auromira Entertainment uses the collected data for various purposes:</p>
...
Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.</p>
                        ...
                        <p>Auromira Entertainment will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

                        <h2>8. Disclosure of Data</h2>

                        <p>We may disclose personal information that we collect, or you provide:</p>
                        <ul>
                            <li>0.1. Business Transaction. If we or our subsidiaries are involved in a merger, acquisition or asset sale, your Personal Data may be transferred.</li>
                            ...
                            <li>0.2.4. for the purpose of including your company’s logo on our website;</li>
                                ...
                                <li>0.2.5. for any other purpose disclosed by us when you provide the information; 0.2.6. with your consent in any other cases; 0.2.7. if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of the Company, our customers, or others.</li>
</ul>
...
<h2>13. Behavioral Remarketing</h2>
...
You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</p>
                                ...
                                <p>If you have any questions about this Privacy Policy, please contact us by email: <a href="mailto:dev@auromirafilms.com">DEV@AUROMIRAFILMS.COM</a>.</p>
